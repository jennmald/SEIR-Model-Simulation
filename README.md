...
The goal was to understand if a system as complex as this could be studied using Euler's Method. Some graphs are shown below and the presntation is uploaded to this repository.
